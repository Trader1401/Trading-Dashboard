                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="long">Long (Buy First)</SelectItem>
                              <SelectItem value="short">Short (Sell First)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormMessage />
                        </FormItem>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredTrades.map((trade) => {
                      ...
                      const exitPrice = parseFloat(trade.exitPrice || "0");
                      const pnl = parseFloat(trade.profitLoss || "0");
                      const pnlPercent = exitPrice > 0 ? calculatePercentage(entryPrice, exitPrice, trade.tradeType || 'long') : 0;
                        ...
                        <TableRow key={trade.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                          ...
                          <TableCell className="font-medium">
                            <div className="flex items-center space-x-2">
                              ...
                              <Badge variant={(trade.tradeType || 'long') === 'short' ? 'destructive' : 'default'} className="text-xs">
                                {(trade.tradeType || 'long').toUpperCase()}
                              </Badge>
                            </div>
                          </TableCell>
                          ...
                          <TableCell>
                            {trade.screenshotLink && trade.screenshotLink.trim() !== '' ? (
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  if (trade.screenshotLink?.trim()) {
    window.open(trade.screenshotLink, '_blank', 'noopener,noreferrer');
  }
                                }}
