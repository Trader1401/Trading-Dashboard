              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className={`font-bold ${pnl >= 0 ? 'text-sm text-green-500' : 'text-sm text-red-500'}`}>
                      {formatCurrency(pnl)}
                    </p>
                    {trade.whichSetup && (
                      <div className="flex items-center justify-end mt-1">
                        <Badge 
                          variant={
                            strategies.find(s => s.name === trade.whichSetup)?.status === "active" ? "default" :
                            strategies.find(s => s.name === trade.whichSetup)?.status === "testing" ? "default" :
                            "secondary"
                          }
                          className="text-xs"
                        >
