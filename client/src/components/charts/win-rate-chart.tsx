...
import { getActiveStrategyTrades } from "@/lib/calculations";
...
export default function WinRateChart({ trades, strategies = [] }: WinRateChartProps) {
  ...
  const breakEvenTrades = activeTrades.length - winningTrades - losingTrades;
        ...
        <div className="h-80 flex items-center justify-center">
          {activeTrades.length === 0 ? (
            <div className="text-center text-gray-500">
              <p>No active strategy trades available</p>
              <p className="text-sm">Add trades with active strategies to see the distribution</p>
            </div>
          ) : (
